...
export async function generateMetadata(): Promise<Metadata> {
  const metadata = constructMetadata({
    title: "About borgman",
    description:
      "Explore the vision, founder, and commitment of borgman, where diversity meets innovation in tech, reviews, entertainment, and news.",
    imgTitle: "Don't live upto your borgmans.",
    imgDesc:
      "Explore the vision, founder, and commitment of borgman, where diversity meets innovation in tech, reviews, entertainment, and news.",
    imgUrl:
            ...
            <div className="relative md:mx-auto md:flex md:max-w-[700px] lg:max-w-none">
              <div className="sm:ml-auto md:ml-[100px] md:max-w-[600px] lg:mx-[100px] text-black">
                <p className="font-poly mb-[20px] text-[17.5px] leading-[1.6] -tracking-[0.01em] selection:bg-[#3cffd033] text-wrap">
                  <em>borgman, &nbsp;</em>
                  we're on a mission to challenge borgmans and break down
                ...
                <p className="font-poly mb-[20px] text-[17.5px] leading-[1.6] -tracking-[0.01em] selection:bg-[#3cffd033]">
                  Here at borgman, founded in 2023, We believe that a
                ...
                <p className="font-poly mb-[20px] text-[17.5px] leading-[1.6] -tracking-[0.01em] selection:bg-[#3cffd033]">
                  ...
                  borgman has something for everyone. Welcome to borgman.
                </p>
                <p className="font-poly mb-[20px] text-[17.5px] leading-[1.6] -tracking-[0.01em] selection:bg-[#3cffd033]">
                  Got a tip for us? &nbsp;
                  <Link
