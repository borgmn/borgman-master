...
export async function generateMetadata(): Promise<Metadata> {
  const metadata = constructMetadata({
    title: "Ethics Statement - borgman",
    description:
      "Explore borgman's ethical principles, our commitment to integrity, inclusivity, and trust. Learn how we uphold the highest standards in tech, reviews, entertainment, and news content.",
  ...
  return (
    <Fragment>
      <div className="z-40 absolute top-0 md:right-[0px] pb-[30px]">
        ...
        >
          <borgman className="h-[50px] w-[270px] md:w-[645.6px] lg:w-[700.7px] md:h-[120px] lg:h-[130px] fill-torq-100 opcatiy-100 md:opacity-50 pl-[9px]" />
        </Link>
      </div>
            ...
            <div className="relative md:mx-auto md:flex md:max-w-[700px] lg:max-w-none">
              <div className="sm:ml-auto md:ml-[100px] md:max-w-[600px] lg:mx-[100px] text-black">
                ...
                <p className="font-poly mb-[20px] text-[17.5px] leading-[1.6] -tracking-[0.01em] selection:bg-[#3cffd033] text-wrap">
                  ...
                  top priority. When engaging with borgman, expect candid,
                  trustworthy content, built on a foundation of honesty.
                </p>
                <p className="font-poly mb-[20px] text-[17.5px] leading-[1.6] -tracking-[0.01em] selection:bg-[#3cffd033] text-wrap">
                  We believe in showcasing diverse perspectives to empower
                  informed choices. borgman is your platform for a wide range
                  ...
                  you make well-rounded decisions. Trust borgman as your
                  source for varied, informed content.
                </p>
                <p className="font-poly mb-[20px] text-[17.5px] leading-[1.6] -tracking-[0.01em] selection:bg-[#3cffd033] text-wrap">
                  borgman is more than content; it's a community of
